...
export function UniexControlPanel({
  ...
  const [activeTab, setActiveTab] = useState<
    "editors_tools" | "jobs" | "gov_jobs" | "private_jobs" | "live_mock_test" | "create_mock_test" | "users" | "pdfs" | "settings" | "total_registration" | "employment_ace" | "homepage_banners" | "job_filters"
  >("editors_tools");
